...
cd "C:\Users\axw161530\Box Sync\Classes\Sem_ResearchAnalysis\Code_Snippets\9_GroupBasedTrajec"
...
*Four group model
traj, var(count_*) indep(t_*) model(zip) order(2 2 2 2) iorder(0)
*Four group model is worse in terms if AIC and BIC, one of the groups ends up being explosive
*From this, would choose the three group model

*Restimate three group model, lets plot some diagnostics
traj, var(count_*) indep(t_*) model(zip) order(2 2 2) iorder(0)
